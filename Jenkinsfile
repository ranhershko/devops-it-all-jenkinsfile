    ...
    properties([
      pipelineTriggers([
        ...
        stage('publish containers') {
          println "repo_files_modified is $repo_files_modified, repo_files_added is: $repo_files_added, repo_files_removed is: $repo_files_removed"
          if (repo_ssh_url != 'empty') {
            container ('docker') {
              env.WORKSPACE = pwd()
        script {
        ...
        //changed_files_n_dirs_list = changed_files_n_dirs_list.join(" ") 
